 ...
 * @return {object} (firstIpAddress) - An object containing both an IPv4 address 
 *                                     and its mapped IPv6 address.
 */
 getFirstIpAddress(cidrStr, callback) {
  ...
  if (!cidr.isValid()) {
    ...
    let [tmpipv4] = cidr.toArray(options);
    let tmpipv6 = getIpv4MappedIpv6Address(tmpipv4);
    firstIpAddress.ipv4 = tmpipv4;
    firstIpAddress.ipv6 = tmpipv6;
